...
&nbsp;
    if (this.singleValue) {
      try {
        data = _.isArray(data) ? <span class="branch-0 cbranch-no" title="branch not covered" >data.map(SingleValueStream.singleValue) </span>: SingleValueStream.singleValue(data);
      } catch (e) {
